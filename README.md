...
> >4.1.创建/views/interfaceText.jsp
> > ```
...
> >4.3.在要生成接口文档的接口上使用@ZA_InterfaceNotes与@ZA_InterfaceNotesParameter注解,如上面的MainController

> >4.4.创建一个接口用于把接口文档输出到jsp
> > ```
> > @Controller
